<header id="header" class="d-flex align-items-center fixed-top ">
  <div class="container d-flex align-items-center">
    ...
    <div class="logo me-auto">
      ...
      <a href="../"><img src="../assets/img/logo/SALOGO2.png" alt="" class="img-fluid"></a>
    </div>
      ...
      <ul>
        ...
        <li class="dropdown" onmouseover="program()" onclick="pro()"><a class="nav-link" href="#">Programs</a>
          <ul class="dropdown-remove d-none">
            ...
            <li><a class="nav-link scrollto" href="../linux-administration/">Linux & Administration</a></li>
            <li><a class="nav-link scrollto" href="../mobailapp-development/">Mobile App Development</a></li>
  ...
  <div class=" mega-menu d-hidden shadow " id="mega-menu" onmouseleave="pronon()">
    <div class="navbar">
      <ul>
      <li>   <li><a class="nav-link scrollto" href="../programming-fundamental/">Programming Fundamentals</a></li>
            <li><a class="nav-link scrollto" href="../fullstack-python/">Full Stack Python</a></li>
            <li><a class="nav-link scrollto" href="../software-testing/">Software Testing</a></li>
            <li><a class="nav-link scrollto" href="../dbms/">DBMS and DBA</a></li>
            <li><a class="nav-link scrollto" href="../net-development/">.NET Development</a></li>
