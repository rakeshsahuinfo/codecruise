        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-7 ">
                <div class="card car" data-aos="zoom-in">
                    <img src="../assets/img/topic/MEAN-Stack-Development-Services-2048x1152.jpg" alt="" class="p-3">
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-5">
                <div class="card dis">
                    <h4 class="p-4"> MEAN STACK DEVELOPMENT</h4>
                    <div class="card-body">
                        <p class="p-2">
        ...
        <div class="row" id="col">
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow " data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/R.png" alt="" class="p-3 ">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow" data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/R.jfif" alt="" class="p-3">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow " data-aos="zoom-in-up">
                    <img src="../assets/img/topic/OIP.jfif" alt="" class="p-3 ">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow" data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/OIP (1).jfif" alt="" class="p-3">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow" data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/maxresdefault.jpg" alt="" class="p-3">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow " data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/OIP (2).jfif" alt="" class="p-3">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow" data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/download.jfif" alt="" class="p-3">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow" data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/angular-logo-min.jpg" alt="" class="p-3">
                    <div class="card-tittle  px-4">ANGULAR JS</div>
                    <div class="card-body">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow" data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/download (1).jfif" alt="" class="p-3">
                    <div class="card-tittle px-4">EXPRESS JS</div>
                    <div class="card-body">
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow" data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/OIP (3).jfif" alt="" class="p-3">
                    <div class="card-tittle px-4">NODE JS</div>
                    <div class="card-body">
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow" data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/download (2).jfif" alt="" class="p-3">
                    <div class="card-tittle px-4">MONGO DB</div>
                    <div class="card-body">
                        <hr>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow" data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/download (3).jfif" alt="" class="p-3">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow " data-aos="zoom-in-up">
                    <img src="../assets/img/topic/download (1).jfif" alt="" class="p-3">
