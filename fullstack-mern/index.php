...
<body>
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-7 ">
                <div class="card car" data-aos="zoom-in">
                    <img src="../assets/img/topic/OIP (1).jfif" alt="" class="p-3">
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-5">
                <div class="card dis">
                    <h4 class="p-4"> MERN STACK DEVELOPMENT</h4>
                    <div class="card-body">
                        <p class="p-2">
    ...
    <div class="container">
        <div class="row" id="col">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2">
                <div class="card shadow" data-aos="zoom-in-up">
                    <img src="../assets/img/IMGS/OIP (7).jfif" alt="" class="p-3">
                    <div class="card-tittle  px-4">REACT JS</div>
                    <div class="card-body">
