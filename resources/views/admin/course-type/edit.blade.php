...
@section('title','CODECRUISE | EDIT COURSE TYPE')
@section('headasset')
@stop
@section('content')
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h3 class="mt-4 text-uppercase">Edit Course Type</h3>
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active"><a href="#">{{$coursetype->name}}</a></li>
                    ...
                    <div class="card-body">
                        <div class="col-md-8 offset-md-1">
                            <form id="create-property-amenity" method="POST"
                                action="{{route('update-course-type')}}">
                                      ...
                                      <input type="hidden" name="course_type_id" value="{{$coursetype->id}}">
                                        ...
                                        <div class="form-group w-100 my-4">
                                            ...
                                            <select class="selectpicker form-control" data-live-search="true" data-size="8" name="is_active" id="is_active" required>
                                                <option value="1"  {{$coursetype->is_active==1?"selected":""}}>Active</option>
                                                <option value="0" {{$coursetype->is_active==0?"selected":""}}>Inactive</option>
                                            </select>
                                        </div>
                                      
                                        <div class="form-group text-center mt-2" style="width: 100%;">
                                            <button type="submit" class="btn btn-submit btn-dark w-100">UPDATE COURSE TYPE <i class="fas fa-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
