                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="col-md-8 offset-md-1">
                            <form id="create-property-amenity" method="POST" action="{{route('create-course')}}"
                                    ...
                                    <div class="form-row form-row-2 px-3 py-2">
                                        ...
                                        <div class="form-group w-100  my-4">
                                            ...
                                            <input type="text" class="form-control" name="current_discount"
                                                id="current_discount" placeholder="10% or Flat Rs.2000">
                                        </div>
                                        <div class="form-group w-100 my-4">
                                        ...
                                        <div class="form-group w-100  my-4">
                                            ...
                                            <input type="file" accept="image/*" class="form-control"
                                                name="course_banner" id="course_banner" required>
                                        </div>
                                        ...
                                        <div class="form-group text-center mt-2" style="width: 100%;">
                                            <button type="submit" class="btn btn-submit btn-dark w-100">CRAETE COURSE <i
