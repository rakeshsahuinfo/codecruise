                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header text-center"><a href="{{route('landing-page')}}"><img src="{{asset('admin/assets/img/logo-white.png')}}" alt="" class="img-fluid" style="width: 200px;height: auto;"></a></div>
                                    <div class="card-body">
