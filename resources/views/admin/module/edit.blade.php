                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="col-md-8 offset-md-1">
                            <form id="create-property-amenity" method="POST" action="{{route('update-course-module')}}"
                                ...
                                <div class="bp-list-wrapper">
                                    ...
                                    <div class="form-row form-row-2 px-3 py-2">
                                        ...
                                        <div class="form-group text-center mt-2" style="width: 100%;">
                                            <button type="submit" class="btn btn-submit btn-dark w-100">UPDATE COURSE
