        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('admin-promo-session')}}">promo Sessions</a></li>
                    ...
                    <div class="card-body">
                        <div class="col-md-8 offset-md-1">
                            <form id="create-property-amenity" method="POST"
                                action="{{route('create-promo-session')}}" enctype="multipart/form-data">
                                <div class="bp-list-wrapper">
                                    ...
                                    <div class="form-row form-row-2 px-3 py-2">
                                        ...
                                        <div class="form-group w-100  my-4">
                                            ...
                                            <textarea class="form-control" name="description" id="description" cols="30" rows="25"></textarea>
                                        </div>
                                      
                                        <div class="form-group w-100  my-4">
                                            <label for="promo_banner">Promo Banner</label>
                                            <input type="file" accept="image/*" class="form-control" name="promo_banner" id="promo_banner" required>
                                        </div>
                                        ...
                                        <div class="form-group text-center mt-2" style="width: 100%;">
                                            <button type="submit" class="btn btn-submit btn-dark w-100">CRAETE PROMO SESSION <i class="fas fa-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
