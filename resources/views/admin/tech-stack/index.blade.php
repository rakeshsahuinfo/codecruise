                                ...
                                <tr>
                                    <td>
                                        <div class='d-flex'>
                                            ...
                                            <a href="{{route('edit-tech-stack',$ts->id)}}" title="Edit Tech Stack" class='mx-3 text-primary'> <i class='fas fa-edit'></i></a>
                                            <a href="{{route('edit-tech-stack',$ts->id)}}" title="Delete Tech Stack" class='text-danger'> <i class='fas fa-trash'></i></a>
                                        </div>
                                    </td>
                                    <td>{{$ts->name}}</td>
                                    <td>
