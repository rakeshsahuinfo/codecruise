...
@section('title','CODECRUISE | NEW TECh STACK')
@section('headasset')
@stop
@section('content')
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h3 class="mt-4 text-uppercase">New Tech Stack</h3>
                    ...
                    <div class="card-body">
                        <div class="col-md-8 offset-md-1">
                            <form id="create-property-amenity" method="POST"
                                action="{{route('create-tech-stack')}}" enctype="multipart/form-data">
                                <div class="bp-list-wrapper">
                                    ...
                                    <div class="form-row form-row-2 px-3 py-2">
                                        ...
                                        <div class="form-group text-center mt-2" style="width: 100%;">
                                            <button type="submit" class="btn btn-submit btn-dark w-100">CRAETE TECH STACK <i class="fas fa-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
