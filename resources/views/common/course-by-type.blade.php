                    ...
                    <div class="col-md-6 col-lg-4 col-xxl-3 filter-item cat1 cat3">
                        <div class="course-box2 style2">
                            <div class="course-img">
                                <a href="{{route('course',base64_encode($c->id))}}"><img src="{{asset('course_banner/'.$c->course_banner)}}" alt="course" style="height: 180px;"></a>
                                <span class="tag"><a href="{{route('enroll-course',base64_encode($c->id))}}">Enroll</a></span>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="course-grid">
                            ...
                            <div class="course-content">
                                ...
                                <h3 class="course-title"><a href="course-details.html">The Complete HTML & CSS Bootcamp 2023 Edition</a></h3>
                                <p class="course-text">Through our initiatives, we aim to bridge educational gaps. We are committed to making a positive impact on education globally improve learning outcomes.</p>
                                <div class="course-meta style2">
                                    <span><i class="fal fa-file"></i>Lesson 8</span>
                                    <span><i class="fal fa-user"></i>Students 60+</span>
                    ...
                    <div class="col-12">
                        <div class="course-grid">
                            ...
                            <div class="course-content">
                                ...
                                <h3 class="course-title"><a href="course-details.html">Fashion Photography From To Professional Courses</a></h3>
                                <p class="course-text">We aim to bridge educational gaps, improve learning outcomes. We are committed to making a positive impact on education globally, through our initiatives.</p>
                                <div class="course-meta style2">
                                    <span><i class="fal fa-file"></i>Lesson 9</span>
                                    <span><i class="fal fa-user"></i>Students 50+</span>
