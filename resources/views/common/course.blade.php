                ...
                <div class="course-single">
                    <div class="course-single-top">
                        ...
                        <div class="course-meta style2">
                            ...
                            <span><i class="fal fa-calendar"></i>Last Update :
                                {{Carbon\Carbon::parse($courseinfo->updated_at)->format('d M Y')}}</span>
                        </div>
                        ...
                        <div class="tab-content" id="productTabContent">
                            ...
                            <div class="tab-pane fade" id="instructor" role="tabpanel" aria-labelledby="instructor-tab">
                                <div class="course-instructor">
                                    <br>
                                    <h5 class="h5">Tech Stack Covered</h5>

                                    <div class="row" data-slide-show="4" data-ml-slide-show="3" data-lg-slide-show="3"
                                        ...
                                        <div class="container mt-2">
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 d-flex">
                                                    <div class="card shadow flex-fill" data-aos="zoom-in-up"
                                                        style="height: 90%;">
                                                        <img src="{{ asset('tech_stack/' . $ts->tech_stack_logo) }}"
                                                            style="width: 120px;height:120px;margin: 5px auto;border-radius: 5px;"
                                                            class="p-3">
                                                        <div class="card-tittle px-4 text-center sub-title fs-6">
                                                            {{$ts->name}}</div>
...
<section class="space-bottom">
    <div class="container">
        <div class="row">
            <h4 class="sec-title">Codecruise offers Certificate of Participation and Completion Certificate with QR Code
            </h4>
            ...
            <div class="col-xl-6 mb-30 mb-xl-0">
                <div class="cta-card" data-bg-src="{{asset('common/assets/img/update1/bg/Participation.png')}}">
                    ...
                    <a href="{{route('enroll-course',$courseinfo->slug)}}" class="th-btn">Certificate of Participation<i
            ...
            <div class="col-xl-6">
                <div class="cta-card" data-bg-src="{{asset('common/assets/img/update1/bg/Completion.png')}}">
                    ...
                    <a href="{{route('enroll-course',$courseinfo->slug)}}" class="th-btn">Certificate of Completion<i
                            class="fas fa-arrow-right ms-2"></i></a>
                </div>
            </div>
        </div>
