                        ...
                        <div class="widget widget_nav_menu footer-widget">
                            ...
                            <div class="menu-all-pages-container">
                                <ul class="menu">
                                    @if($ctype)
                                    @foreach($ctype as $ct)
                                    <li><a href="{{route('course-by-type',$ct->slug)}}">{{$ct->name}}</a></li>
                                    @endforeach
                                    @endif
                                </ul>
                            </div>
        ...
        <div class="container">
            <div class="copyright-wrap">
                <div class="row justify-content-between align-items-center">
                    <div class="col-md-6">
                        <p class="copyright-text">Copyright © 2024 <a href="{{route('landing-page')}}">CodeCruise</a> Powered By <a href="https://whizzact.com" target="_blank">WhizzAct</a> 
