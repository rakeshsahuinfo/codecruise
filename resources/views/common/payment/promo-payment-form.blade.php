        ...
        <div class="row">
            ...
            <div class="col-xl-5">
                <div class="contact-form-wrap" data-bg-src="assets/img/bg/contact_bg_1.png">
                    ...
                    <form id="payment-form" method="post" action="{{route('process-promo-payment')}}"  class="contact-form">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control style-white" name="amount"
                                        id="amount" placeholder="0.00" value="{{$proses->fees}}" readonly>
                                    <i class="fal fa-inr"></i>
                                </div>
                            </div>
                            <input type="hidden" name="reg_code" value="{{$prosesr->reg_code}}">
                            <div class="form-btn col-12 mt-10">
                                <button type="submit" class="th-btn">Pay Now<i class="fas fa-long-arrow-right ms-2"></i></button>
                            </div>
                        </div>
