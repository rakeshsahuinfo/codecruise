    ...
    <div class="row">
        <div class="col-12 col-md-6 col-lg-7">
            ...
            <div data-aos="zoom-out-down" class="w-100 d-flex">
                <a href="{{route('enroll-course',encrypt($courseinfo->id))}}" class="btn btn-success mx-4 text-uppercase">
                ...
                <button type="button" class="btn btn-warning float-end mx-4 text-uppercase">
                    <h3><span class="badge badge-light">Discount<br>{{$courseinfo->current_discount}}</span></h3>
                </button>
                @endif
            </div>
        </div>
