<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="5000">
            <img src="{{asset('assets/img/slide/slide-11.png')}}" class="d-block img-fluid brightness" id="img1" alt="...">
        ...
        <div class="carousel-item" data-bs-interval="5000">
            <img src="{{asset('assets/img/slide/slide-22.png')}}" class="d-block img-fluid brightness"
                id="img2" alt="...">
            <div class="carousel-caption d-md-block">
        ...
        <div class="carousel-item">
            <img src="{{asset('assets/img/slide/slide-33.png')}}" class="d-block img-fluid brightness" id="img3"
                alt="...">
            <div class="carousel-caption d-md-block">
